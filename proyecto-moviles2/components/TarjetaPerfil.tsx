    ...
    return (
        ...
        >
            <View style={styles.infoTarjeta}>
                <Text style={styles.txtNombre}>Usuario</Text>
                <Text style={styles.txtEmail}>correo@ejemplo.com</Text>
                
                <View style={styles.btnVerMas}>
                    <Text style={styles.txtVerMas}>VER STATS</Text>
                </View>
            </View>
            ...
            >
                <View style={styles.fondoModal}>
                    <View style={styles.cuerpoModal}>
                        ...
                        <Text style={styles.tituloModal}>Usuario</Text>
                        <Text style={styles.subtituloModal}>correo@ejemplo.com</Text>

                        <View style={styles.cajaStats}>
                            <View style={styles.filaStat}>
                                <Text style={styles.txtStatLabel}>PARTIDAS:</Text>
                                <Text style={styles.txtStatVal}>0</Text>
                            </View>
                        </View>
